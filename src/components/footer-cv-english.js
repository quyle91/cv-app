const FooterCvEnglish = () => {
    return (
    <>
        <footer id="footer-cv-english" className="w3-xlarge">
            <div className="w3-padding-large">
                ...
                <span className="w3-margin-right w3-medium">I'm also on socials</span>        
            </div>    
        </footer>
    </>
    )
}
export default FooterCvEnglish